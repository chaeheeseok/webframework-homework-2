-- admin 계정 등록 (비밀번호: admin1234)
INSERT INTO users (email, password, role)
VALUES ('admin@hansung.ac.kr',
        '$2a$10$C.rcQ.Jhp1UqRGr7xA3kf.C7Ox0V1FawKEyb/O4dTzMQMYkz77wQ.',
        'ROLE_ADMIN');

insert into product (name, brand, made_in, price)
values ('Galaxy S6', 'Samsung Corp', 'Korea', 600.0);
insert into product (name, brand, made_in, price)
values ('Galaxy S8', 'Samsung Corp', 'Korea', 800.0);
insert into product (name, brand, made_in, price)
values ('Galaxy S10', 'Samsung Corp', 'Korea', 1000.0);
insert into product (name, brand, made_in, price)
values ('Galaxy S21', 'Samsung Corp', 'Korea', 1000.0);
